...
object MyOpenIDUser extends MyOpenIDUser with MetaOpenIDProtoUser[MyOpenIDUser] with LongKeyedMetaMapper[MyOpenIDUser] {
  ...
  override def dbTableName = "openidusers"
...
class MyOpenIDUser extends LongKeyedMapper[MyOpenIDUser] with OpenIDProtoUser[MyOpenIDUser] {
  def getSingleton = MyOpenIDUser
}
